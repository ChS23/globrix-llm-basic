...
**Answer Relevancy (97.5%)** - Отлично!
- Ответы точно соответствуют заданным вопросам
- Минимум нерелевантной информации в ответах

**Faithfulness (91.8%)** - Отлично!
- Ответы основаны на контексте, минимум галлюцинаций
- Система не выдумывает факты

**Contextual Precision (86.6-89.1%)** - Хорошо
...
- Это особенность chunking стратегии (chunk_size=1000), а не проблема поиска
